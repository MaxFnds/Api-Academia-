...
describe("TreinoRepository", () => {
  ...
  beforeEach(() => {
    jest.clearAllMocks();
    fsMock.readFileSync.mockReturnValue(JSON.stringify(treinosFake) as any);
  ...
  it("deve criar um novo treino", () => {
    const novo = new Treino("t4", "Treino de Costas", "a2", "i1", ["e3"], "2026-07-24T13:00:00.000Z");
  ...
  it("deve atualizar um treino existente", () => {
    const atualizado = new Treino("t1", "Treino Superior Avançado", "a1", "i1", ["e1", "e3", "e4"], "2026-07-24T11:00:00.000Z");
