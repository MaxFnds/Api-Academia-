...
describe("Instrutor", () => {
    ...
    it("deve criar um instrutor válido com especialidade", () => {
        const instrutor = new Instrutor_1.Instrutor("i1", "Carlos Souza", "carlos@email.com", "hashDaSenha123", "CrossFit");
    ...
    it("deve criar uma instância a partir de um objeto JSON", () => {
        ...
        const instrutor = Instrutor_1.Instrutor.fromJSON(dados);
        expect(instrutor.getNome()).toBe("Rafael Nunes");
        expect(instrutor.getEspecialidade()).toBe("Funcional");
    });
});
//# sourceMappingURL=Instrutor.test.js.map