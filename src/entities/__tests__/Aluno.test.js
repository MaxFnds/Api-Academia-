...
describe("Aluno", () => {
    ...
    it("deve criar um aluno válido com todos os campos", () => {
        const aluno = new Aluno_1.Aluno("a1", "Maria Silva", "maria@email.com", "hashDaSenha123", "2026-07-20T14:00:00.000Z", 24, "uploads/a1.jpg");
    ...
    it("deve criar um aluno válido sem idade e sem foto", () => {
        const aluno = new Aluno_1.Aluno("a2", "João Costa", "joao@email.com", "hashDaSenha456", "2026-07-20T14:05:00.000Z");
    ...
    it("não deve permitir nome vazio", () => {
        expect(() => {
            new Aluno_1.Aluno("a3", "", "teste@email.com", "hash123", "2026-07-20T14:00:00.000Z");
        }).toThrow("O nome do aluno é obrigatório.");
    });
    // Teste 4: email inválido (sem @) deve lançar erro
    it("não deve permitir email sem @", () => {
        expect(() => {
            new Aluno_1.Aluno("a4", "Teste", "emailinvalido.com", "hash123", "2026-07-20T14:00:00.000Z");
        }).toThrow("Email inválido.");
    });
    // Teste 5: senha vazia deve lançar erro
    it("não deve permitir senha vazia", () => {
        expect(() => {
            new Aluno_1.Aluno("a5", "Teste", "teste@email.com", "", "2026-07-20T14:00:00.000Z");
        }).toThrow("A senha é obrigatória.");
    });
    // Teste 6: toJSON deve gerar o objeto correto
    it("deve converter para JSON corretamente", () => {
        const aluno = new Aluno_1.Aluno("a6", "Ana Paula", "ana@email.com", "hash789", "2026-07-20T14:10:00.000Z", 30);
    ...
    it("deve criar uma instância a partir de um objeto JSON", () => {
        ...
        const aluno = Aluno_1.Aluno.fromJSON(dados);
