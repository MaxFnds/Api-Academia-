...
const Treino_1 = require("../Treino");
describe("Treino", () => {
    // Teste 1: criação válida com exercícios
    it("deve criar um treino válido", () => {
        const treino = new Treino_1.Treino("t1", "Treino de Pernas", "a1", "i1", ["e1", "e2"], "2026-07-20T14:00:00.000Z");
    ...
    it("deve criar um treino válido sem exercícios ainda", () => {
        const treino = new Treino_1.Treino("t2", "Treino Vazio", "a1", "i1", [], "2026-07-20T14:00:00.000Z");
        expect(treino.getExercicios()).toEqual([]);
    });
    // Teste 3: nome vazio deve lançar erro
    it("não deve permitir nome vazio", () => {
        expect(() => {
            new Treino_1.Treino("t3", "", "a1", "i1", [], "2026-07-20T14:00:00.000Z");
    ...
    it("não deve permitir treino sem aluno vinculado", () => {
        expect(() => {
            new Treino_1.Treino("t4", "Treino Teste", "", "i1", [], "2026-07-20T14:00:00.000Z");
    ...
    it("não deve permitir treino sem instrutor vinculado", () => {
        expect(() => {
            new Treino_1.Treino("t5", "Treino Teste", "a1", "", [], "2026-07-20T14:00:00.000Z");
    ...
    it("deve adicionar um exercício ao treino", () => {
        const treino = new Treino_1.Treino("t6", "Treino Teste", "a1", "i1", ["e1"], "2026-07-20T14:00:00.000Z");
    ...
    it("não deve permitir adicionar o mesmo exercício duas vezes", () => {
        const treino = new Treino_1.Treino("t7", "Treino Teste", "a1", "i1", ["e1"], "2026-07-20T14:00:00.000Z");
        expect(() => {
    ...
    it("deve remover um exercício do treino", () => {
        const treino = new Treino_1.Treino("t8", "Treino Teste", "a1", "i1", ["e1", "e2"], "2026-07-20T14:00:00.000Z");
    ...
    it("não deve permitir alterar a lista interna via getExercicios", () => {
        const treino = new Treino_1.Treino("t9", "Treino Teste", "a1", "i1", ["e1"], "2026-07-20T14:00:00.000Z");
    ...
    it("deve converter para JSON corretamente", () => {
        const treino = new Treino_1.Treino("t10", "Treino Full Body", "a1", "i1", ["e1", "e2"], "2026-07-20T14:30:00.000Z");
    ...
    it("deve criar uma instância a partir de um objeto JSON", () => {
        ...
        const treino = Treino_1.Treino.fromJSON(dados);
...
//# sourceMappingURL=Treino.test.js.map